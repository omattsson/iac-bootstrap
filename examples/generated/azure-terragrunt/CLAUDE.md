...
- Single resources use identifier `"default"` (e.g., `azurerm_user_assigned_identity.default`)
...
```hcl
moved {
  from = azurerm_user_assigned_identity.old_name
  to   = azurerm_user_assigned_identity.default
}
```
