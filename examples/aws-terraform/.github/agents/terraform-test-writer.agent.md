...
## Test Categories
1. **Naming** — default name, length limits, full_name override, lowercase sanitization
...
4. **VPC endpoints / private access** — created per map entry, naming, empty map = none
5. **Outputs** — name, id, and arn populated
