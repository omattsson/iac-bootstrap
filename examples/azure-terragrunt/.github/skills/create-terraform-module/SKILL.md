...
description: "Create a new reusable Terraform module following Contoso conventions. Use when: scaffolding a new tf-module-* repo, adding Azure resource modules, creating module boilerplate."
---
