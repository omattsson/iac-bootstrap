...
description: "Create or extend Terragrunt stacks, components, and environments. Use when: adding a new component to a stack, onboarding a new environment/region, creating _envcommon configs, wiring dependencies."
---
...
2. Add module version to `account.hcl` → `module_tags`
...
3. Module version tag exists in `account.hcl`
