---
description: "Plan and design infrastructure changes across the Acme AWS platform. Use when: designing new infrastructure components, planning multi-repo changes, analyzing impact of infrastructure modifications, reviewing cross-stack dependencies."
